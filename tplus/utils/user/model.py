...
class DelegatedUser(User):
    ...
    def sign(self, payload: str):
        """Sign with the registered co-signer key.

        Prefer :meth:`signing_parts` for protocol requests so this signature
        is placed in ``additional_signers``, not the master-signature field.
        """

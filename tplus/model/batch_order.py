...
def parse_batch_order_response(parsed_batch_order_response: dict) -> BatchCreateOrderRequestResponse:
    ...
    return BatchCreateOrderRequestResponse(batch_create_order_request_response=list_of_single_orders_from_batch)

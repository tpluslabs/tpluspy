...
from tplus.model.trades import TradeEvent, parse_trade_event, TradeConfirmedEvent
...
def test_parse_trade_event():
    ...
    assert ev.trade.asset_id == AssetIdentifier("82af49447d8a07e3bd95bd0d56f35241523fbab1000000000000000000000000@000000000000a4b1")
